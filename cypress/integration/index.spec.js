...
const userUrl =
  'http://cloud.local.graasp.eu:8080/index.html?appInstanceId=1&userId=1';
const adminUrl =
  'http://cloud.local.graasp.eu:8080/index.html?appInstanceId=1&mode=admin';
...
describe('app', function() {
  ...
  context('admin mode', function() {
    ...
    it('cy.get() - query dom elements', function() {
      ...
      cy.get('ul.view-select').should('be.visible');
